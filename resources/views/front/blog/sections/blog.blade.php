            ...
            <ul class="nav unstyled nav-pills gap-12 d-flex mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-views-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-views" type="button" role="tab" aria-c
                        aria-selected="false">Top views</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-latest-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-latest" type="button" role="tab" aria-c
                        aria-selected="false">Latest</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-rated-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-rated" type="button" role="tab" aria-c
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="blog-card">
                            ...
                            <div class="text-block">
                                ...
                                <a href="{{ route('blog.detail') }}" class="title mb-16">Navigating the Rental Market: Essential and Essential  Don'ts...
                                </a>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="blog-card">
                            ...
                            <div class="text-block">
                                <p class="mb-12">April 7, 2024</p>
                                <a href="blogs.html" class="title mb-16">The Art of Home Staging: Transforming Spaces to Tenants...</a>
                                <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                    nascetur
                                    ipsum .</p>
                                <a href="{{ route('blog.detail') }}" class="cus-btn-2">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="blog-card">
                            ...
                            <div class="text-block">
                                <p class="mb-12">April 7, 2024</p>
                                <a href="blogs.html" class="title mb-16">Rental Renovation: Smart Upgrades Add Value and
                                    Charm...
                                </a>
                                <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                    nascetur
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="blog-card">
                            ...
                            <div class="text-block">
                                <p class="mb-12">April 7, 2024</p>
                                <a href="blogs.html" class="title mb-16">The Art of Home Staging: Transforming Spaces to Tenants..
                                </a>
                                <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                    nascetur
                                    ipsum .</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-card">
                            ...
                            <div class="text-block">
                                <p class="mb-12">April 7, 2024</p>
                                <a href="blogs.html" class="title mb-16">EcoTenant Troubles? Mastering Resolution in Rental
                                    Properties...</a>
                                <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                    nascetur
                                    ipsum .</p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-card">
                            ...
                            <div class="text-block">
                                <p class="mb-12">April 7, 2024</p>
                                <a href="blogs.html" class="title mb-16">Eco-Friendly Rentals: Sustainability Solutions for Property
                                    Owners...</a>
                                <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                    nascetur
                                    ipsum .</p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-card">
                            ...
                            <div class="text-block">
                                <p class="mb-12">April 7, 2024</p>
                                <a href="blogs.html" class="title mb-16 ">The Rise of Remote Work: Rental Properties for the Digital
                                    Nomad...
                                </a>
                                <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                    nascetur
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-card">
                            ...
                            <div class="text-block">
                                <p class="mb-12">April 7, 2024</p>
                                <a href="blogs.html" class="title mb-16">Pets Welcome! Creating Pet-Friendly Environments...</a>
                                <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                    nascetur
                                    ipsum .</p>
                                <a href="{{ route('blog.detail') }}" class="cus-btn-2">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-card">
                            ...
                            <div class="text-block">
                                <p class="mb-12">April 7, 2024</p>
                                <a href="{{ route('blog.detail') }}" class="title mb-16">Pets Welcome! Creating Pet-Friendly Environments in Rental
                                    Homes...
                                </a>
                                <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                    nascetur
